...
* [sterglee/scalalab](https://github.com/sterglee/scalalab) - ScalaLab: Efficient MATLAB like scientific computing for the Java platform with the current Scala 2.13. Similar functionality for Kotlin offers the KotlinLab project, https://github.com/sterglee/kotlinlab
...
* [plokhotnyuk/rtree2d](https://github.com/plokhotnyuk/rtree2d) - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries
