...
* [krasserm/streamz](https://github.com/krasserm/streamz) - An FS2 (Functional Streams for Scala) interface for Akka Streams and Apache Camel
...
* [KyleU/boilerplay](https://github.com/KyleU/boilerplay) - Using the latest technology in the Scala ecosystem, Boilerplay is a reactive web application built on Play 2.5, ScalaJS, Silhouette 4, and postgres-async. It provides a good starting point for whatever you want to build.
