...
* [sksamuel/elastic4s](https://github.com/sksamuel/elastic4s) - Elasticsearch Scala Client - Non Blocking, Type Safe, Reactive HTTP Client
...
* [scalameta/metals](https://github.com/scalameta/metals) - Work-in-progress language server for Scala
...
* [debiki/talkyard](https://github.com/debiki/talkyard) - Open source StackOverflow, Slack, Discourse, Reddit, Disqus hybrid — for your online community.
...
* [khipu-io/khipu](https://github.com/khipu-io/khipu) - A Scala/Akka implementation of the Ethereum protocol
...
* [epfl-lara/stainless](https://github.com/epfl-lara/stainless) - Verification framework for higher-order Scala programs
...
* [loicdescotte/pureWebappSample](https://github.com/loicdescotte/pureWebappSample) - Minimal http4s + Doobie + ZIO + Circe application to show how to build a purely functional web application in Scala.
...
* [STHSF/TextRank](https://github.com/STHSF/TextRank) - 基于TextRank的关键词、短语、摘要提取程序，代码使用Scala编写。
...
* [gothinkster/scala-play-realworld-example-app](https://github.com/gothinkster/scala-play-realworld-example-app) - Exemplary real world application built with Scala & Play
...
* [softwaremill/akka-http-session](https://github.com/softwaremill/akka-http-session) - Client-side akka-http sessions
