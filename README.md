...
* [mohiva/play-silhouette](https://github.com/mohiva/play-silhouette) - Silhouette is an authentication library for Play Framework applications that supports several authentication methods, including OAuth1, OAuth2, OpenID, CAS, 2FA, TOTP, Credentials, Basic Authentication or custom authentication schemes.
...
* [fthomas/scala-steward](https://github.com/fthomas/scala-steward) - :robot: A robot that helps you keeping your Scala projects up-to-date
...
* [pauldijou/jwt-scala](https://github.com/pauldijou/jwt-scala) - JWT support for Scala. Bonus extensions for Play, Play JSON, Json4s, Circe, uPickle, Spray and Argonaut
...
* [scalajp/scala_text](https://github.com/scalajp/scala_text) - Scala学習用テキスト
* [ReactiveMongo/Play-ReactiveMongo](https://github.com/ReactiveMongo/Play-ReactiveMongo) - ReactiveMongo plugin for Playframework
...
* [propensive/fury](https://github.com/propensive/fury) - Fury
...
* [higherkindness/droste](https://github.com/higherkindness/droste) - to iterate is human, to recurse, divine
...
* [AbsaOSS/spline](https://github.com/AbsaOSS/spline) - Data Lineage Tracking and Visualization tool for Apache Spark ™
...
* [higherkindness/mu](https://github.com/higherkindness/mu) - Mu is a purely functional library for building RPC endpoint based services with support for RPC and HTTP/2
...
* [ovotech/fs2-kafka](https://github.com/ovotech/fs2-kafka) - Functional Kafka Streams for Scala
...
* [STHSF/TextRank](https://github.com/STHSF/TextRank) - 基于TextRank的中文关键词、短语、摘要提取程序，代码使用Scala编写。
...
* [ITV/scala-pact](https://github.com/ITV/scala-pact) - A Scala implementation of CDC using the Pact standard
...
* [scala/scala-collection-compat](https://github.com/scala/scala-collection-compat) - Scala 2.13 Collection Compatibility Library
* [scala/community-build](https://github.com/scala/community-build) - build a corpus of open-source repos against nightly Scala builds
...
* [regb/scala-game-library](https://github.com/regb/scala-game-library) - Cross-platform game engine for Scala - in development
* [lightbend/scala-sculpt](https://github.com/lightbend/scala-sculpt) - Dependency extraction for Scala codebases, to aid in modularizing
...
* [Verizon/helm](https://github.com/Verizon/helm) - A native Scala client for interacting with Consul
...
* [NewMotion/ocpp](https://github.com/NewMotion/ocpp) - Open Charge Point Protocol
...
* [scalacenter/scalac-profiling](https://github.com/scalacenter/scalac-profiling) - Implementation of SCP-010.
...
* [fomkin/pushka](https://github.com/fomkin/pushka) - ABANDONED Pure Scala serialization library with annotations
...
* [rdbc-io/rdbc](https://github.com/rdbc-io/rdbc) - Asynchronous database access for Scala and Java
* [politrons/reactiveScala](https://github.com/politrons/reactiveScala) - Example of  Features, Reactive and Pure functional programing in Scala
...
* [scalaz/scalaz-plugin](https://github.com/scalaz/scalaz-plugin) - A compiler plugin that will improve on the scala compiler on the assumption that the user is using the Scalazzi-safe subset of Scala.
...
* [akka-js/shocon](https://github.com/akka-js/shocon) - Simple pure-scala Typesafe HOCON implementation using FastParse
...
* [mgdigital/Chromaprint.scala](https://github.com/mgdigital/Chromaprint.scala) - Chromaprint/AcoustID audio fingerprinting for the JVM
* [mefellows/sbt-dotenv](https://github.com/mefellows/sbt-dotenv) - Simple Dotenv implementation for Scala SBT Builds. Configures environment for local development.
...
* [erikerlandson/coulomb](https://github.com/erikerlandson/coulomb) - coulomb: a statically typed unit analysis library for Scala
* [dwestheide/kontextfrei](https://github.com/dwestheide/kontextfrei) - Writing application logic for Spark jobs that can be unit-tested without a SparkContext
* [Centaur/scalaconsole](https://github.com/Centaur/scalaconsole) - Scala REPL in a GUI
* [azakordonets/fabricator](https://github.com/azakordonets/fabricator) - Fabricator is a minimalist generator of random strings, numbers, etc. to help reduce some monotony particularly while writing automated tests or anywhere else you need anything random. It's written on scala but fully backward compatible with Java.
...
* [outworkers/reactiveneo](https://github.com/outworkers/reactiveneo) - [DISCONTINUED] Reactive type-safe Scala driver for Neo4J
* [jstrachan/scopt](https://github.com/jstrachan/scopt) - simple scala command line options parsing
* [janstenpickle/extruder](https://github.com/janstenpickle/extruder) - Populate Case Classes From Any Data Source
* [enshahar/BasicFPinScala](https://github.com/enshahar/BasicFPinScala) - Leaning functional program in Scala
...
* [swaldman/sbt-ethereum](https://github.com/swaldman/sbt-ethereum) - An sbt-based solidity / scala development environment, and general command-line power tool, for Ethereum.
* [Spinoco/fs2-kafka](https://github.com/Spinoco/fs2-kafka) - Kafka client for functional streams for scala (fs2)
...
* [adornes/spark_scala_ml_examples](https://github.com/adornes/spark_scala_ml_examples) - Spark 2.0 Scala Machine Learning examples
...
* [AVSystem/scala-commons](https://github.com/AVSystem/scala-commons) - AVSystem commons library for Scala
...
* [apollographql/apollo-scalajs](https://github.com/apollographql/apollo-scalajs) - Use Apollo GraphQL from Scala.js apps!
...
* [epfl-lara/stainless](https://github.com/epfl-lara/stainless) - 💯  Verification framework and tool for higher-order Scala programs
...
* [powerapi-ng/powerapi-scala](https://github.com/powerapi-ng/powerapi-scala) - PowerAPI is a middleware toolkit for building software-defined power meters
...
* [scalaz/scalaz-schema](https://github.com/scalaz/scalaz-schema) - A purely-functional library for defining type-safe schemas for algebraic data types, providing free generators, SQL queries, JSON codecs, binary codecs, and migration from this schema definition
...
* [scalaz/scalaz-zio](https://github.com/scalaz/scalaz-zio) - ZIO — A type-safe, composable library for asynchronous and concurrent programming in Scala
...
* [ThoughtWorksInc/sbt-api-mappings](https://github.com/ThoughtWorksInc/sbt-api-mappings) - An Sbt plugin that fills apiMappings for common Scala libraries.
* [scalaz/scalaz-analytics](https://github.com/scalaz/scalaz-analytics) - A high-performance, purely-functional library for doing computational analysis and statistics over data in a type-safe way
...
* [xxxnell/flip](https://github.com/xxxnell/flip) - Fast and lightweight probability tools for a dataset and a data stream.
* [nihirash/ells](https://github.com/nihirash/ells) - Embeddable Lisp-Like Scripting
...
* [pshirshov/izumi-r2](https://github.com/pshirshov/izumi-r2) - Productivity-oriented collection of lightweight fancy stuff for Scala toolchain
* [pk11/sedis](https://github.com/pk11/sedis) - a thin scala wrapper for jedis (https://github.com/xetorthio/jedis)
* [pjfanning/swagger-akka-http-sample](https://github.com/pjfanning/swagger-akka-http-sample) - Sample demonstrating use of swagger-akka-http
* [iamthiago/cassandra-phantom](https://github.com/iamthiago/cassandra-phantom) - Cassandra + Phantom Example
...
* [lucidd/scala-js-chrome](https://github.com/lucidd/scala-js-chrome) - ScalaJS bindings for Chrome Extention/App and ChromeOS APIs
...
* [circe/circe-magnolia](https://github.com/circe/circe-magnolia) - Circe codec derivation using magnolia
...
* [jfkelley/argyle](https://github.com/jfkelley/argyle) - Scala command-line arguments parser
* [BasileDuPlessis/scala-for-the-impatient](https://github.com/BasileDuPlessis/scala-for-the-impatient) - Solutions for "Scala for the Impatient" exercises
...
* [Sagacify/sonar-scala](https://github.com/Sagacify/sonar-scala) - Sonarqube plugin for scala analysis
...
* [GetJenny/starchat](https://github.com/GetJenny/starchat) - An Open Source, scalable conversational engine for B2B applications.
* [anskarl/LoMRF](https://github.com/anskarl/LoMRF) - LoMRF is an open-source implementation of Markov Logic Networks
* [scalatra/scalatra.g8](https://github.com/scalatra/scalatra.g8) - A giter8 template for a basic Scalatra SBT project
...
* [kenkoooo/AtCoderProblems](https://github.com/kenkoooo/AtCoderProblems) - Problem manager for AtCoder users
...
* [eclipsesource/play-json-schema-validator](https://github.com/eclipsesource/play-json-schema-validator) - JSON Schema Validation with Play JSON
...
* [Spirals-Team/powerapi](https://github.com/Spirals-Team/powerapi) - PowerAPI is a middleware toolkit for building software-defined power meters
...
* [andyscott/droste](https://github.com/andyscott/droste) - to iterate is human, to recurse, divine
* [propensive/kaleidoscope](https://github.com/propensive/kaleidoscope) - Compile-time-checked string pattern matching for Scala
* [bitbart/blockapi](https://github.com/bitbart/blockapi) - A general framework for blockchain analytics
* [scala-native/scala-native.g8](https://github.com/scala-native/scala-native.g8) - Giter8 template for a minimal project that uses Scala Native.
...
* [47deg/LambdaTest](https://github.com/47deg/LambdaTest) - Functional testing for Scala.
* [miloszpp/scala-ts](https://github.com/miloszpp/scala-ts) - Scala to TypeScript code generator
* [outr/reactify](https://github.com/outr/reactify) - The first and only true Functional Reactive Programming framework for Scala.
...
* [datasift/dropwizard-scala](https://github.com/datasift/dropwizard-scala) - Scala language integration for Dropwizard
* [dcos/cosmos](https://github.com/dcos/cosmos) - Provides an API for the orderly, harmonious, and complete management of DC/OS service packages
...
* [scalikejdbc/hello-scalikejdbc](https://github.com/scalikejdbc/hello-scalikejdbc) - Lightbend Activator Template for ScalikeJDBC Beginners
...
* [koalanlp/KoalaNLP-core](https://github.com/koalanlp/KoalaNLP-core) - KoalaNLP = Korean + Scala + NLP. 한국어 형태소 및 구문 분석기의 모음입니다.
* [LinMingQiang/spark-util](https://github.com/LinMingQiang/spark-util) - :boom: :alien: :hotsprings::rocket:Encapsulated spark/sparkstreaming to read Kafka with Low level integration (offset in zookeeper).:point_right::point_right::point_right:And encapsulate other component tools.like hbase,flink,kudu,es, spark kafka and so on
...
* [creative-scala/doodle](https://github.com/creative-scala/doodle) - Compositional vector graphics in Scala / Scala.JS
...
* [MediaMath/scala-json](https://github.com/MediaMath/scala-json) - Compile-time JSON marshaling and abstraction for Scala, Scala Native and Scala.js
* [Ldpe2G/PCANet](https://github.com/Ldpe2G/PCANet) - convert the matlab code of PCANet to C++ & Scala
...
* [atomist-attic/rug](https://github.com/atomist-attic/rug) - DEPRECATED Runtime for Rugs
...
* [src-d/engine](https://github.com/src-d/engine) - engine is a library for running scalable data retrieval pipelines that process any number of Git repositories for source code analysis.
...
* [jmvanel/semantic_forms](https://github.com/jmvanel/semantic_forms) - Form generators leveraging semantic web standards (RDF(S), OWL, SPARQL , ...
...
* [NextGenTel/akka-tools](https://github.com/NextGenTel/akka-tools) - Open source tools to simplify Akka event sourcing, journaling/persistence, serialization, clustering and sharding.
* [japgolly/scalajs-benchmark](https://github.com/japgolly/scalajs-benchmark) - Benchmarks: write in Scala or JS, run in your browser. Live demo:
...
* [javaBin/scala-training-code](https://github.com/javaBin/scala-training-code) - --- LEGAZY!!! --- Contains code necessary participate in the Scala training course.
...
* [truerss/truerss](https://github.com/truerss/truerss) - convenient web rss-reader
...
* [alexandru/sincron](https://github.com/alexandru/sincron) - Concurrency tools for Scala, with equivalents for Scala.js.
...
* [mdedetrich/scalajson](https://github.com/mdedetrich/scalajson) - ScalaJSON - JSON for Scala, currently contains minimal AST
...
* [eHarmony/aloha](https://github.com/eHarmony/aloha) - A scala-based feature generation and modeling framework
...
* [domino-osgi/domino](https://github.com/domino-osgi/domino) - OSGi dynamics made easy - A Scala DSL to master OSGi dynamics
...
* [outworkers/phantom-activator-template](https://github.com/outworkers/phantom-activator-template) - Typesafe Activator seed with Phantom and Play! Framework.
...
* [woshilaiceshide/s-server](https://github.com/woshilaiceshide/s-server) - Some Small Servers written in Scala
...
* [jeremyrsmith/patchless](https://github.com/jeremyrsmith/patchless) - Patch data type for Scala and shapeless
...
* [velvia/filo](https://github.com/velvia/filo) - Fast, memory-efficient, minimal-serialization, binary data vectors for Scala and other languages
...
* [konstructs/server](https://github.com/konstructs/server) - A voxel based game server.
...
* [ElderResearch/ssc](https://github.com/ElderResearch/ssc) - Simple Scala Config: Typesafe Config wrapped in a `Dynamic` blanket.
* [eamelink/swaggerkit](https://github.com/eamelink/swaggerkit) - A Scala Swagger toolkit with no JaxRS dependency and no magic.
* [Verizon/nelson](https://github.com/Verizon/nelson) - Automated, multi-region container deployment
* [CERT-BDF/Cortex](https://github.com/CERT-BDF/Cortex) - Powerful Observable Analysis Engine
* [unicredit/shocon](https://github.com/unicredit/shocon) - Simple pure-scala Typesafe HOCON implementation using FastParse
* [apache/incubator-predictionio-template-recommender](https://github.com/apache/incubator-predictionio-template-recommender) - PredictionIO Recommendation Engine Template (Scala-based parallelized engine)
* [apache/incubator-predictionio-template-ecom-recommender](https://github.com/apache/incubator-predictionio-template-ecom-recommender) - PredictionIO E-Commerce Recommendation Engine Template (Scala-based parallelized engine)
...
* [jeffplaisance/scala-protobuf](https://github.com/jeffplaisance/scala-protobuf) - protoc plugin that generates type safe scala wrappers for java protoc output
* [Daxten/bay-scalajs.g8](https://github.com/Daxten/bay-scalajs.g8) - A ScalaJs Template with scaffolding, postgres, scalajs-react and play-framework in the backend
...
* [antonkulaga/scala-js-binding](https://github.com/antonkulaga/scala-js-binding) - ScalaJS html binding library
* [xiaodongw/swagger-finatra](https://github.com/xiaodongw/swagger-finatra) - Finatra Swagger Support
...
* [gaocegege/scrala](https://github.com/gaocegege/scrala) - :whale: :coffee: :spider: Scala crawler(spider) framework, inspired by scrapy
...
* [m50d/paperdoll](https://github.com/m50d/paperdoll) - Scala implementation of "Freer Monads, More Extensible Effects" - see http://okmij.org/ftp/Haskell/extensible/more.pdf
* [knoldus/playing-microservices.g8](https://github.com/knoldus/playing-microservices.g8) - This activator project describes Microservice architecture design using Play 2.4.x and Scala
* [fcabestre/Scala-MQTT-client](https://github.com/fcabestre/Scala-MQTT-client) - A Scala MQTT client library
* [kakao/mango](https://github.com/kakao/mango) - Core utility library & data connectors designed for simpler usage in Scala
...
* [CSUG/sbt-one-log](https://github.com/CSUG/sbt-one-log) - sbt-one-log make Log dependency easy
* [coursera/autoschema](https://github.com/coursera/autoschema) - Generates JSON Schema from Scala classes
* [guardian/scanamo](https://github.com/guardian/scanamo) - Simpler DynamoDB access for Scala
* [vmunier/akka-http-with-scalajs-example](https://github.com/vmunier/akka-http-with-scalajs-example) - Example application showing how you can integrate Akka HTTP with Scala.js.
* [scala-native/sbt-crossproject](https://github.com/scala-native/sbt-crossproject) - Cross-platform compilation support for sbt.
...
* [ClaireNeveu/macrame](https://github.com/ClaireNeveu/macrame) - Macrame provides macro-based replacements for parts of the Scala standard library.
* [ThoughtWorksInc/enableIf.scala](https://github.com/ThoughtWorksInc/enableIf.scala) - A library that toggles Scala code at compile-time, like #if in C/C++
...
* [radanalyticsio/silex](https://github.com/radanalyticsio/silex) - something to help you spark
* [adelbertc/aiyou](https://github.com/adelbertc/aiyou) - IO types and classes for Scala.
...
* [typesafehub/migration-manager](https://github.com/typesafehub/migration-manager) - Scala Binary Compatibility validation tool
* [benhutchison/mouse](https://github.com/benhutchison/mouse) - A small companion to cats
...
* [SumoLogic/elasticsearch-client](https://github.com/SumoLogic/elasticsearch-client) - Elasticsearch Client for Scala that operates against the REST Endpoint
...
* [ainterface/ainterface](https://github.com/ainterface/ainterface) - Runs an Erlang node on an ActorSystem of Akka.
* [sbt/jacoco4sbt](https://github.com/sbt/jacoco4sbt) - JaCoCo Code Coverage plug-in for sbt.
* [scalamacros/scalamacros](https://github.com/scalamacros/scalamacros) - New-style Scala macros.
* [atomist/rug](https://github.com/atomist/rug) - Runtime for Rugs
...
* [scodec/scodec-stream](https://github.com/scodec/scodec-stream) - Binding between scodec and FS2
...
* [apache/incubator-predictionio-template-similar-product](https://github.com/apache/incubator-predictionio-template-similar-product) - PredictionIO Similar Product Engine Template (Scala-based parallelized engine)
...
* [abbruzze/kernal64](https://github.com/abbruzze/kernal64) - A Scala Commodore 64 & 128 emulator
...
* [playframework/play-scala-secure-session-example](https://github.com/playframework/play-scala-secure-session-example) - An example Play application showing encrypted session management
...
* [gupta-himanshu/play-reactive-slick](https://github.com/gupta-himanshu/play-reactive-slick) - This is Play Template with a nice User Interface. If you want to use Play as web framework and Postgres as Database then this demo project can be used as a starting point for your application.
* [cretz/scala-web-ideal](https://github.com/cretz/scala-web-ideal) - Akka HTTP + Scala.js + ScalaTags + ScalaCSS + Autowire + Prickle + akka-sse + Gradle + etc... (outdated/stale)
...
* [LappleApple/api-first-hand](https://github.com/LappleApple/api-first-hand) - API-First bootstrapping tool for building RESTful web services from a Swagger/OpenAPI spec
...
* [gaocegege/scala-renren](https://github.com/gaocegege/scala-renren) - scala 实现的人人网好友关系图
* [zalando/api-first-hand](https://github.com/zalando/api-first-hand) - API-First bootstrapping tool for building RESTful web services from a Swagger/OpenAPI spec
* [47deg/iota](https://github.com/47deg/iota) - Fast coproduct types with a clean syntax
* [paypal/horizon](https://github.com/paypal/horizon) - An SBT plugin to help with building, testing, analyzing and releasing Scala
* [gengstrand/clojure-news-feed](https://github.com/gengstrand/clojure-news-feed) - evaluating various technologies by implementing a news feed micro-service
...
* [ucb-bar/chisel3](https://github.com/ucb-bar/chisel3) - Chisel 3
...
* [openmole/mgo](https://github.com/openmole/mgo) - Purely functionnal genetic algorithms
...
* [ucb-bar/rocket-chip](https://github.com/ucb-bar/rocket-chip) - Rocket Chip Generator
...
* [47deg/macroid](https://github.com/47deg/macroid) - A modular functional UI language for Android
* [47deg/freestyle](https://github.com/47deg/freestyle) - A cohesive & pragmatic framework of FP centric Scala libraries
* [scala-native/scala-native-example](https://github.com/scala-native/scala-native-example) - Example sbt project that uses Scala Native.
* [razie/gremlins](https://github.com/razie/gremlins) - scala workflow DSL - see examples below or post questions to the forum
* [keplar/google-analytics-export-to-csv](https://github.com/keplar/google-analytics-export-to-csv) - A command-line tool for exporting data from Google Analytics to CSV. Use it to feed Tableau, R etc. Built in Scala
...
* [47deg/scala-commas](https://github.com/47deg/scala-commas) - A compiler plugin to add support for trailing commas in Scala 2.11
* [MetaStack-pl/MetaRx](https://github.com/MetaStack-pl/MetaRx) - Reactive data structures for Scala and Scala.js
* [kaliber-scala/scala-mailer](https://github.com/kaliber-scala/scala-mailer) - Play mailer module based on Amazon SES
* [melrief/pureconfig](https://github.com/melrief/pureconfig) - A boilerplate-free library for loading configuration files
* [tmbo/deep-nlp-scala](https://github.com/tmbo/deep-nlp-scala) - Using deep learning to POS tag sentences using scala + DL4J
* [smarter/dotty-example-project](https://github.com/smarter/dotty-example-project) - An example sbt project that compiles using Dotty
...
* [cassandra-scala/troy](https://github.com/cassandra-scala/troy) - Type-safe and Schema-safe Scala wrapper for Cassandra driver
...
* [playframework/play-rest-api](https://github.com/playframework/play-rest-api) - Example Play Scala application showing REST API
...
* [playframework/play-scala](https://github.com/playframework/play-scala) - Play starter project in Scala
...
* [scala-js/scalajs-tutorial](https://github.com/scala-js/scalajs-tutorial) - Source code accompanying the Scala.js tutorial
* [rathboma/scala-libgdx-examples](https://github.com/rathboma/scala-libgdx-examples) - Libgdx examples built with scala
* [openmole/scalaWUI](https://github.com/openmole/scalaWUI) - A ready to work Client/Server application built with Scalatra, scalaJS, scalaTags, scalarx and autowire. An example using the D3.js lib.
* [nestorpersist/logging](https://github.com/nestorpersist/logging) - Scala Logging Library
* [Karasiq/scalajs-bootstrap](https://github.com/Karasiq/scalajs-bootstrap) - Scala.js bootstrap components
...
* [ldaniels528/scalajs.io](https://github.com/ldaniels528/scalajs.io) - Complete set of Scala.js bindings for Node.js, io.js,  Angular.js, many popular npm modules (mongodb, moment, rx, etc.) and the MEAN Stack (MongoDB, Express, Angular, Node and more). **With Examples**
...
* [kaja47/sketches](https://github.com/kaja47/sketches) - Scala library for sketching, locality sensitive hashing, approximate similarity search and other things
...
* [vpavkin/scala-js-momentjs](https://github.com/vpavkin/scala-js-momentjs) - Scala.js façade for Moment.js
...
* [piotrMocz/scalajs-java](https://github.com/piotrMocz/scalajs-java) - Project aims to compile Java sources into Scala.js IR
* [nicolasstucki/scala-rrb-vector](https://github.com/nicolasstucki/scala-rrb-vector) - Implementation and benchmarking of Scala Vectors with relaxed radix balanced trees for more efficient concatenations
* [mziccard/scala-audio-file](https://github.com/mziccard/scala-audio-file) - Minimal Scala library to process audio files
...
* [ticofab/simple-play-websocket-server](https://github.com/ticofab/simple-play-websocket-server) - Example WebSocket server built with Scala and Play Framework.
* [ThoughtWorksInc/todo](https://github.com/ThoughtWorksInc/todo) - Binding.scala • TodoMVC
...
* [scalameta/tutorial](https://github.com/scalameta/tutorial) - Whirlwind tour of scala.meta
* [oyediyildiz/scala-oauth2-provider-example](https://github.com/oyediyildiz/scala-oauth2-provider-example) - Example db schema and DataHandler.scala implementation for nulab scala-oauth2-provider
...
* [danielkorzekwa/atpworldtour-api](https://github.com/danielkorzekwa/atpworldtour-api) - Scala API for atpworldtour.com tennis statistics
...
* [bizreach/aws-dynamodb-scala](https://github.com/bizreach/aws-dynamodb-scala) - Scala client for Amazon DynamoDB
* [alcestes/lchannels](https://github.com/alcestes/lchannels) - Session programming in Scala
...
* [underscoreio/scalax15-slick](https://github.com/underscoreio/scalax15-slick) - Slick workshop for Scala Exchange 2015
* [underscoreio/scalax15-interpreters](https://github.com/underscoreio/scalax15-interpreters) - Source code for the Interpreters workshop at Scala Exchange 2015.
* [strelec/QuantumLearn](https://github.com/strelec/QuantumLearn) - :thought_balloon: An improved Machine Learning library in Scala.
* [stacycurl/pimpathon](https://github.com/stacycurl/pimpathon) - Adds useful methods to scala & java classes.
* [ScalaWilliam/xs4s](https://github.com/ScalaWilliam/xs4s) - XML Streaming for Scala
* [runarorama/scarpia](https://github.com/runarorama/scarpia) - A Scala port of the Parsec parser combinator library
* [runarorama/scala-bound](https://github.com/runarorama/scala-bound) - A library for developing languages with scoped binders (like forall or lambda).
* [rocketraman/activator-akka-scala-guice](https://github.com/rocketraman/activator-akka-scala-guice) - Typesafe Activator demo for Akka, Scala, Guice
* [nafg/slick-additions](https://github.com/nafg/slick-additions) - Helpers for Scala Slick (slick.typesafe.com)
* [msgpack4z/msgpack4z-core](https://github.com/msgpack4z/msgpack4z-core) - typeclass based functional msgpack serializer/deserializer for Scala / msgpack.org[Scala]
...
* [kovacshuni/koauth](https://github.com/kovacshuni/koauth) - OAuth 1.0a provider and consumer library for Scala & Java, storage independent/pluggable, async/reactive, designed to be used within a completely RESTful API.
...
* [snowplow/scala-forex](https://github.com/snowplow/scala-forex) - High-performance Scala library for performing exchange rate lookups and currency conversions
* [pavelfatin/scala-for-project-euler](https://github.com/pavelfatin/scala-for-project-euler) - Concise functional solutions to the Project Euler problems
* [NCR-CoDE/sonar-scalastyle](https://github.com/NCR-CoDE/sonar-scalastyle) - SonarQube plugin for ScalaStyle
* [mpilquist/scalaz-talk](https://github.com/mpilquist/scalaz-talk) - Slides and example code from a training presentation on Scalaz 7
* [jhc-systems/sqlest](https://github.com/jhc-systems/sqlest) - Write SQL in Scala
* [ezhulenev/scala-openbook](https://github.com/ezhulenev/scala-openbook) - Scala library for parsing TAQ NYSE OpenBook Ultra
* [daveray/rooscaloo](https://github.com/daveray/rooscaloo) - Rete-based rule engine in Scala
* [apache/incubator-predictionio-template-attribute-based-classifier](https://github.com/apache/incubator-predictionio-template-attribute-based-classifier) - PredictionIO Classification Engine Template (Scala-based parallelized engine)
* [andreaferretti/paths-scala-js](https://github.com/andreaferretti/paths-scala-js) - Scala.js binding for Paths.js
...
* [bwmcadams/quaich](https://github.com/bwmcadams/quaich) - Scala Serverless Microframework for AWS Lambda, inspired by Amazon's Chalice (https://github.com/awslabs/chalice)
* [ldaniels528/scalajs-node-npm](https://github.com/ldaniels528/scalajs-node-npm) - Complete set of Scala.js bindings for Angular.js, Node.js, npm and the MEAN Stack (MongoDB, Express, Angular, Node and more). **With Examples**
* [47deg/scalacheck-datetime](https://github.com/47deg/scalacheck-datetime) - A library for helping use datetime libraries with ScalaCheck
* [pongr/spracebook](https://github.com/pongr/spracebook) - Async Scala SDK for the Facebook Graph API, built on spray-client and spray-json.
* [feijoas/mango](https://github.com/feijoas/mango) - The purpose of the Mango library is to provide Guava (Google's core libraries) functionalities to Scala
* [emchristiansen/PersistentMap](https://github.com/emchristiansen/PersistentMap) - A type-safe, boilerplate-free, key-value store in Scala
* [uclmr/stat-nlp-book-scala](https://github.com/uclmr/stat-nlp-book-scala) - Interactive book on Statistical NLP
* [teigen/maven-scalatest-plugin](https://github.com/teigen/maven-scalatest-plugin) - Maven support for ScalaTest
* [regb/scabolic](https://github.com/regb/scabolic) - Package for a computer algebra system integrated with satisfiability modulo theory algorithms, developed in Scala.
* [msilb/akka-trading](https://github.com/msilb/akka-trading) - Scala Backtesting + Oanda REST API Trading Framework built on top of Akka/Spray
* [milesegan/scala-hadoop-example](https://github.com/milesegan/scala-hadoop-example) - A translation of the WordCount example from the Hadoop tutorial from Java to Scala.
* [jrudolph/scala-enhanced-strings](https://github.com/jrudolph/scala-enhanced-strings) - Variable interpolation and formatting strings for Scala
* [gw111zz/HelloScalaOnAndroid](https://github.com/gw111zz/HelloScalaOnAndroid) - A basic Android project using Scala
* [ept/neo4j-resources](https://github.com/ept/neo4j-resources) - Scala implementation of RESTful JSON HTTP resources on top of the Neo4j graph database and Jersey
* [emstlk/nacl4s](https://github.com/emstlk/nacl4s) - Scala implementation of Networking and Cryptography (NaCl) library
* [ceecer1/play211-scala210-spring3-Hibernate4](https://github.com/ceecer1/play211-scala210-spring3-Hibernate4) - This repository contains the code base for configuring Play Framework 2.1.1 and Scala 2.10 with Spring 3 for Dependency Injection and Hibernate 4 as ORM framework.
* [andreyk0/redis-client-scala-netty](https://github.com/andreyk0/redis-client-scala-netty) - Scala redis client built with netty framework
...
* [ldaniels528/transcendent.js](https://github.com/ldaniels528/transcendent.js) - Complete set of Scala.js bindings for Angular.js, Node.js and the MEAN Stack (MongoDB, Express, Angular, Node and more). **With Examples**
* [fluent/fluent-logger-scala](https://github.com/fluent/fluent-logger-scala) - A structured logger implementation in Scala.
* [shadaj/GameOfLife](https://github.com/shadaj/GameOfLife) - Conway's Game Of Life using Scala and Processing
* [nbronson/ccstm](https://github.com/nbronson/ccstm) - CCSTM is a library-based STM for Scala
* [densh/joyquote](https://github.com/densh/joyquote) - A tutorial on how to embed subset of Joy into Scala via extensible string interpolation and macros
* [chrisnappin/play-recaptcha](https://github.com/chrisnappin/play-recaptcha) - Play Framework (Scala and Play 2.x) module that provides reactive (non-blocking) integration with Google ReCaptcha.
* [nfolkert/scala-foursquare-api](https://github.com/nfolkert/scala-foursquare-api) - Scala wrapper for foursquare API - see README for details on how to get started
...
* [monix/sincron](https://github.com/monix/sincron) - Concurrency tools for Scala, with equivalents for Scala.js.
* [IainHull/resttest](https://github.com/IainHull/resttest) - A lightweight Scala DSL for system testing REST web services
* [Srirangan/simplewebcrawler](https://github.com/Srirangan/simplewebcrawler) - A simple web crawler desgined to showcase scalability with Scala and GridGain
* [kaisellgren/ScalaGit](https://github.com/kaisellgren/ScalaGit) - A pure Scala implementation of the Git version control written from scratch.
* [julianpeeters/case-class-generator](https://github.com/julianpeeters/case-class-generator) - Dynamically defines and loads Scala classes at runtime.  Useful for turning JSON schemas into Scala case classes on the fly.
* [JorgeCastilloPrz/ScalaForTheImpatient](https://github.com/JorgeCastilloPrz/ScalaForTheImpatient) - Project created to learn Scala basics by solving all the scala exercises proposed by the book.
* [GiGurra/heisenberg](https://github.com/GiGurra/heisenberg) - A scala library for dynamic data
* [FaKod/Circuit-Breaker-for-Scala](https://github.com/FaKod/Circuit-Breaker-for-Scala) - Guard external service access with a Circuit Breaker based on the book "Release It" (Michael Nygard)
* [eltimn/scamongo](https://github.com/eltimn/scamongo) - Scala library for MongoDB
* [CodeMettle/jsactor](https://github.com/CodeMettle/jsactor) - Actors on Scala.js
* [A-OK/Snakes-and-Ladders](https://github.com/A-OK/Snakes-and-Ladders) - Python\Scala Interop Sample Code
...
* [ymasory/puritan](https://github.com/ymasory/puritan) - [DEFUNCT] Referentially Transparent IO for Scala
* [ekalyoncu/vangas-cassandra](https://github.com/ekalyoncu/vangas-cassandra) - Asynchronous and non-blocking Scala driver for Apache Cassandra
* [dwestheide/learn-you-an-sbt-example](https://github.com/dwestheide/learn-you-an-sbt-example) - Learn you an SBT for fun and profit – Scala Days 2014 example project
* [zoheb/scala-springmvc-thymeleaf-bootstrap-template](https://github.com/zoheb/scala-springmvc-thymeleaf-bootstrap-template) - A starter web application project combining Scala, Spring, Spring MVC, Thymeleaf 2.0, Spring Security and twitter bootstrap.
* [w11k/scala-lang-osgi](https://github.com/w11k/scala-lang-osgi) - OSGified Scala libraries
* [Sciss/ScalaOSC](https://github.com/Sciss/ScalaOSC) - OpenSoundControl (OSC) library for the Scala programming language
* [markusgumbel/scalabioalg](https://github.com/markusgumbel/scalabioalg) - Algorithms and tools for bioinformatics and life science informatics written in Scala
* [djspiewak/scala-collections](https://github.com/djspiewak/scala-collections) - A number of collection implementations for Scala (including a few ported from Clojure)
...
* [tferi/templateFX](https://github.com/tferi/templateFX) - TemplateFX is a JavaFX UI definition and reconcilation library, written in Scala.
* [tarao/lambda-scala](https://github.com/tarao/lambda-scala) - Type level lambda calculus in Scala
* [takezoe/poi4s](https://github.com/takezoe/poi4s) - Elegant interface to Excel for Scala
* [nraychaudhuri/scala-remote-repl](https://github.com/nraychaudhuri/scala-remote-repl) - Connect a Scala REPL to running Play/Scala processes
* [mattbowen/akka-web-template](https://github.com/mattbowen/akka-web-template) - A sbt-based, scala Akka project that sets up a web project with REST and comet support.
* [jedesah/scala-codesheet-api](https://github.com/jedesah/scala-codesheet-api) - Scala evaluation engine
* [Guidewire/marathon-client](https://github.com/Guidewire/marathon-client) - Simple Scala client for communicating with Marathon
* [gnieh/tiscaf](https://github.com/gnieh/tiscaf) - lightweight HTTP server for Scala
* [FaKod/JPA-for-Scala](https://github.com/FaKod/JPA-for-Scala) - Extended JPA / ORM / persistence layer for Scala to ease JPA 2.0 development
* [cascala/galileo](https://github.com/cascala/galileo) - Scala Math - Numerical (Matlab-like) and Symbolic (Mathematica-like) tool
* [alexice/template-scala-parallel-svd-item-similarity](https://github.com/alexice/template-scala-parallel-svd-item-similarity) - Prediction.IO template for item similarity measurement
...
* [PredictionIO/template-scala-parallel-classification](https://github.com/PredictionIO/template-scala-parallel-classification) - PredictionIO Classification Engine Template (Scala-based parallelized engine)
* [Villane/scalabox2d](https://github.com/Villane/scalabox2d) - Scala port of JBox2D
* [Treode/cps](https://github.com/Treode/cps) - Continuations for Asynchronous IO (abandoned due to Scala bug)
* [theon/xsbt-coveralls-plugin](https://github.com/theon/xsbt-coveralls-plugin) - sbt plugin for uploading Scala code coverage to coveralls
* [sonoisa/Prolog-in-Scala](https://github.com/sonoisa/Prolog-in-Scala) - A Prolog Implementation(Internal DSL, External DSL, REPL) in Scala.
* [sebnozzi/sliding-puzzle](https://github.com/sebnozzi/sliding-puzzle) - Sliding puzzle game implemented in Scala / Scala.js / JavaFX
* [sandgorgon/z](https://github.com/sandgorgon/z) - Plan 9 Acme Inspired Editor, done in Scala.
* [rbarooah/simpledb-scala-binding](https://github.com/rbarooah/simpledb-scala-binding) - Scala binding for Amazon simpleDB
* [pvlugter/ants](https://github.com/pvlugter/ants) - Scala port of the Clojure ants demo
* [OpenBankProject/Social-Finance](https://github.com/OpenBankProject/Social-Finance) - Scala Lift Web Application consuming the OBP API.
* [mardambey/spiffy](https://github.com/mardambey/spiffy) - Spiffy is a minimalistic framework for building HTTP services and web applications making use of Akka and Scala DSLs with emphasis on scalability and agility.
* [guggla/guggla](https://github.com/guggla/guggla) - JSR 223 compliant Scala scripting engine. Supports OSGi and JCR.
* [GrahamLea/SodaTest](https://github.com/GrahamLea/SodaTest) - SodaTest (Spreadsheet-Driven Testing) is an open-source framework for creating Executable Requirements for Integration, Functional and Acceptance testing using Scala or Java.
* [davidB/vscaladoc](https://github.com/davidB/vscaladoc) - A variation of scaladoc : an API generator for project written in Scala
* [chrsan/css-selectors-scala](https://github.com/chrsan/css-selectors-scala) - An implementation of the W3C Selectors Level 3 specification In Scala.
* [Banno/salat-avro](https://github.com/Banno/salat-avro) - Fast bi-directional Scala case class to Avro serialization
* [99XProblems/99-Scala-Problems](https://github.com/99XProblems/99-Scala-Problems) - :bulb: 99 Scala Problems
* [vatel/scala-akka-monitoring](https://github.com/vatel/scala-akka-monitoring) - Experiments with monitoring of Akka actors
* [tlazaro/scala-metagun](https://github.com/tlazaro/scala-metagun) - Scala + Libgdx Implementation of Notch's Metagun
* [jsuereth/scala-mojo-support](https://github.com/jsuereth/scala-mojo-support) - Helper to create maven mojo projects in the Scala languages
* [greencatsoft/scalajs-d3](https://github.com/greencatsoft/scalajs-d3) - D3.js bindings for Scala.js
...
* [zcox/javaee6-books-scala](https://github.com/zcox/javaee6-books-scala) - The books example from Beginning Java EE 6 Platform with GlassFish 3 written entirely in Scala
* [osinka/mongo-scala-driver](https://github.com/osinka/mongo-scala-driver) - - deprecated -
* [mandubian/scalaio-2014](https://github.com/mandubian/scalaio-2014) - ScalaIO Talk 2014 code sample
* [krux/hyperion](https://github.com/krux/hyperion) - Scala library and abstractions for AWS DataPipeline
* [ishiijp/Fancy-POI](https://github.com/ishiijp/Fancy-POI) - Fancy scala wrapper for Apache POI
* [gaocegege/scala-github-relationship](https://github.com/gaocegege/scala-github-relationship) - A graphical view of the relationships between github users.
* [FaKod/neo4j-spatial-scala](https://github.com/FaKod/neo4j-spatial-scala) - Scala Wrapper for Neo4j Spatial
* [dlwh/scalanlp-fst](https://github.com/dlwh/scalanlp-fst) - (Weighted) Finite State Transducers for Scala NLP
* [codahale/guild](https://github.com/codahale/guild) - [ABANDONED] Simple, fast actors for Scala.
* [47deg/labs-scala-play-mongo](https://github.com/47deg/labs-scala-play-mongo) - A sample Scala + Play + Reactive Mongo + Iteratees app using the Twitter Streaming API
...
* [foursquare/spindle](https://github.com/foursquare/spindle) - A Scala generator for Thrift.
* [victori/smemcached](https://github.com/victori/smemcached) - Memcached server written in Scala
* [tim-group/lofty](https://github.com/tim-group/lofty) - A dynamic DSL for building complex objects in Scala 2.10
* [jasonbaldridge/akka-tutorial](https://github.com/jasonbaldridge/akka-tutorial) - Code for a tutorial for basic concepts working with Akka using Scala.
* [huntc/webdriver](https://github.com/huntc/webdriver) - An alternate webdriver implementation based on Scala, Akka and Spray
* [dln/loglady](https://github.com/dln/loglady) - Crazy Simple Logging for Scala
* [ben-biddington/Coriander.OAuth](https://github.com/ben-biddington/Coriander.OAuth) - Test-driven, "clean code" pure scala implementation of the OAuth standard.
* [wspringer/sonofjson](https://github.com/wspringer/sonofjson) - Better JSON support for Scala
* [tmiw/newsrdr](https://github.com/tmiw/newsrdr) - Web-based RSS reader in Scala.
* [scottaj/android-scala-example](https://github.com/scottaj/android-scala-example) - An implementation of the "Suggest" example from Ed Burnette's "Hello Android" book. Uses Scala, Scaloid, and Akka actors on Android.
* [okomok/hano](https://github.com/okomok/hano) - Reactive Sequence Combinators in Scala
* [mgutz/sbt-console-template](https://github.com/mgutz/sbt-console-template) - Get started with Scala with tests and console app using this sbt template.
* [mariofusco/hammurabi](https://github.com/mariofusco/hammurabi) - The Scala Rule Engine
* [kouphax/scala-sampleapp](https://github.com/kouphax/scala-sampleapp) - A Play 2 Sample App
* [jenshaase/uimaScala](https://github.com/jenshaase/uimaScala) - A toolkit to write UIMA components and applications
* [dsl-paradise/dsl-paradise](https://github.com/dsl-paradise/dsl-paradise) - Scala syntax extension to allow context/scope propagation in tree-like DSLs
* [debasishg/scala-snippets](https://github.com/debasishg/scala-snippets) - Various Scala snippets of interest - some of them plagiarised
* [davetron5000/shorty](https://github.com/davetron5000/shorty) - RESTful URL Shortener for utf-8 vanity urls, written in Scala
* [cscotta/Octobot-Scala](https://github.com/cscotta/Octobot-Scala) - An (experimental) implementation of the Octobot distributed task queue worker in Scala
* [backuity/matchete](https://github.com/backuity/matchete) - Simple scala matchers
* [alaz/mongo-scala-driver](https://github.com/alaz/mongo-scala-driver) - - deprecated -
* [KimStebel/sprouch](https://github.com/KimStebel/sprouch) - an asynchronous Scala library for CouchDB/BigCouch based on Spray.
* [zilverline/scala-btree](https://github.com/zilverline/scala-btree) - Immutable, in-memory B-Tree implementation for Scala
* [yannart/Scala-Neural-Network](https://github.com/yannart/Scala-Neural-Network) - An implementation of a multi-layer perceptron in Scala
* [typelevel/scalaz-outlaws](https://github.com/typelevel/scalaz-outlaws) - outcasts no longer allowed in the ivory tower
* [t3hnar/scalax](https://github.com/t3hnar/scalax) - Extension for default scala library
* [snowplow/kinesis-example-scala-producer](https://github.com/snowplow/kinesis-example-scala-producer) - Example Scala/SBT event producer for Amazon Kinesis
* [joshrendek/scala-ifcfg-api](https://github.com/joshrendek/scala-ifcfg-api) - The source for http://ifcfg.net/ - a simple way to get BGP information and IP information
* [jducoeur/jquery-facade](https://github.com/jducoeur/jquery-facade) - A strongly-typed Scala.js facade for jQuery
* [jawher/neo4j-scala](https://github.com/jawher/neo4j-scala) - Scala wrapper for Neo4j Graph Database
* [influxdata/influxdb-scala](https://github.com/influxdata/influxdb-scala) - Scala client for InfluxDB
* [eklavya/scala-thrust](https://github.com/eklavya/scala-thrust) - Thrust bindings for Scala
* [eed3si9n/tetrix.scala](https://github.com/eed3si9n/tetrix.scala) - a falling blocks clone
* [derekjw/scala-sass-compiler](https://github.com/derekjw/scala-sass-compiler) - Reimplementation of Haml's Sass for use with the Lift web framework
* [dabreegster/scala-object-explorer](https://github.com/dabreegster/scala-object-explorer) - Use reflection to dump nested case classes
* [Sciss/ScalaInterpreterPane](https://github.com/Sciss/ScalaInterpreterPane) - A simple Swing wrapper using JSyntaxPane to drive the Scala Language Interpreter
...
* [jodersky/flow](https://github.com/jodersky/flow) - Reactive serial communication library for Akka and Scala.
* [nrinaudo/tabulate](https://github.com/nrinaudo/tabulate) - CSV handling library for Scala
* [websudos/reactiveneo](https://github.com/websudos/reactiveneo) - Reactive type-safe Scala driver for Neo4J
* [xerial/silk](https://github.com/xerial/silk) - Simplify SQL Workflows with Scala
* [milankinen/zeison](https://github.com/milankinen/zeison) - Small, fast and easy-to-use JSON library for Scala.
* [takezoe/scalatra-forms](https://github.com/takezoe/scalatra-forms) - A library to validate and map request parameters for Scalatra.
* [flyberry-capital/scala-slack](https://github.com/flyberry-capital/scala-slack) - A Slack client (https://slack.com) for Scala.
* [noelmarkham/scaladays-2015](https://github.com/noelmarkham/scaladays-2015) - Code for my talk, "A purely functional approach to building large applications"
* [zohebsait/scala-springmvc-thymeleaf-bootstrap-template](https://github.com/zohebsait/scala-springmvc-thymeleaf-bootstrap-template) - A starter web application project combining Scala, Spring, Spring MVC, Thymeleaf 2.0, Spring Security and twitter bootstrap.
* [oxbowlakes/foil](https://github.com/oxbowlakes/foil) - foil is a cross-library scheduling DSL for Scala which can be easily integrated into your preferred datetime API - it is a work in progress and there are no build artifacts yet. Have patience! Please see the Wiki section for usage
* [ymasory/scala-corpus](https://github.com/ymasory/scala-corpus) - Large corpus of Scala code for static analysis testing
* [scalatest/scalatestplus-play](https://github.com/scalatest/scalatestplus-play) - ScalaTest plus Play
* [rcoh/toyregex](https://github.com/rcoh/toyregex) - A Toy Regex Engine In Scala
* [aboisvert/stopwatch](https://github.com/aboisvert/stopwatch) - Stopwatch API to easily monitor production Scala applications
* [wfaler/ScalaSSH](https://github.com/wfaler/ScalaSSH) - ScalaSSH - Type-safe shell scripting over SSH with Scala
* [timperrett/spray-html5-sse](https://github.com/timperrett/spray-html5-sse) - HTML5 server-side events with Scala Spray
* [tim-group/eithervalidation](https://github.com/tim-group/eithervalidation) - A simple way to use Scala's standard Either as an applicative functor, without Scalaz, via the #apply method
* [reaktor/sbt-deploy](https://github.com/reaktor/sbt-deploy) - A simple-build-tool plugin for deploying a Scala project to a server
* [namin/lms-sandbox](https://github.com/namin/lms-sandbox) - Graduated to js.scala: JavaScript as an embedded DSL in Scala
* [michaelkebe/pleac-scala](https://github.com/michaelkebe/pleac-scala) - Adding Scala to the PLEAC project
* [league/scala-type-anxiety](https://github.com/league/scala-type-anxiety) - Examples related to a meetup of New York Scala Enthusiasts
...
* [epabst/scala-android-crud](https://github.com/epabst/scala-android-crud) - A Scala framework for supporting CRUD on the Android Platform between UI, Persistence, and Model
* [djspiewak/scala-bison](https://github.com/djspiewak/scala-bison) - A recursive ascent/descent parser generator for Scala
* [bmc/markwrap](https://github.com/bmc/markwrap) - Unified Scala wrapper API around various lightweight markup APIs
* [S-Mach/s_mach.concurrent](https://github.com/S-Mach/s_mach.concurrent) -   s_mach.concurrent is an open-source Scala library that provides asynchronous serial and parallel execution flow control primitives for working with asynchronous tasks. An asynchronous task consists of two or more calls to function(s) that return a future result A ⇒ Future[B] instead of the result A ⇒ B. s_mach.concurrent also provides utility & convenience code for working with scala.concurrent.Future
* [BelfryGames/sloth](https://github.com/BelfryGames/sloth) - Scala LWJGL OpenGL Toolkit from Hell
* [xitrum-framework/xitrum-package](https://github.com/xitrum-framework/xitrum-package) - SBT plugin for collecting dependency .jar files for standalone Scala programs
* [wrwills/formaggio](https://github.com/wrwills/formaggio) - An attempt to port Formlets to Scala
* [timperrett/rabbitmq-scala-tutorial](https://github.com/timperrett/rabbitmq-scala-tutorial) - Tutorial application for Rabbit MQ and Scala
* [swagger-api/swagger-scala-sample-app](https://github.com/swagger-api/swagger-scala-sample-app) - A fully-functioning, stand-alone Swagger server written in scala which demonstrates how to enable Swagger in your API.
* [sujitpal/mia-scala-examples](https://github.com/sujitpal/mia-scala-examples) - Mahout Examples
* [stucchio/scalaz_agent](https://github.com/stucchio/scalaz_agent) - An experimental Agent library based on Scalaz.
* [sellmerfud/optparse](https://github.com/sellmerfud/optparse) - A simple but powerful Scala command line parser
* [scalaz/scalaz-geo](https://github.com/scalaz/scalaz-geo) - Port of scalaz 6.0.4 geo to the new scalaz 7.0.0
* [scalastuff/scalabeans](https://github.com/scalastuff/scalabeans) - Scala reflection and serialization library
* [scalaj/scalaj-reflect](https://github.com/scalaj/scalaj-reflect) - reflection library based on scalap and Scala signatures
* [olim7t/sbt-scalariform](https://github.com/olim7t/sbt-scalariform) - An sbt plugin to format your Scala sources with Scalariform
* [ochafik/scalight](https://github.com/ochafik/scalight) - Trimmed-down Scala : get the language without the runtime !
* [martintrojer/scheme-scala](https://github.com/martintrojer/scheme-scala) - Interpreter of (a subset of) the Scheme programming language, in Scala
* [krishnenc/akka-resque](https://github.com/krishnenc/akka-resque) - A resque clone written using scala/akka
* [influxdb/influxdb-scala](https://github.com/influxdb/influxdb-scala) - Scala client for InfluxDB
* [hubertp/prefuse-type-debugger](https://github.com/hubertp/prefuse-type-debugger) - Type debugger that is using logging infrastructure of the scala compiler to gather information and prefuse library for UI.
* [havocp/beaucatcher](https://github.com/havocp/beaucatcher) - Scala MongoDB API with async and BSON AST -> (JSON or CaseClass) pipeline
* [dylemma/scala.frp](https://github.com/dylemma/scala.frp) - Functional Reactive Programming for Scala
* [djspiewak/scala-stm-proto](https://github.com/djspiewak/scala-stm-proto) - An implementation of a software transactional memory framework in Scala
* [dcbriccetti/bird-show](https://github.com/dcbriccetti/bird-show) - A Scala, lift, Web app for showing pictures from Flickr. See it deployed at http://briccettiphoto.com. Talk slides: http://www.slideshare.net/dcbriccetti
* [daltontf/scala-yaml](https://github.com/daltontf/scala-yaml) - An experimental YAML parser in Scala using parser combinators
* [coursera/courier](https://github.com/coursera/courier) - Scala idiomatic data binding generator for JSON.
* [colder/insane](https://github.com/colder/insane) - Interprocedural Static Analysis Engine for Scala
* [codahale/yoink](https://github.com/codahale/yoink) - [ABANDONED] A Scala library which wraps Clojure's immutable, persistent collections.
* [coconutpalm/XScalaWT](https://github.com/coconutpalm/XScalaWT) - Extensible page description language for SWT written as a Scala internal DSL.  Includes style sheets, data binding, more...  Presentation here: http://www.coconut-palm-software.com/pix/scala_declarative_dsls2.svg
* [boundary/atomicmap_challenge](https://github.com/boundary/atomicmap_challenge) - A multithreaded scala programming challenge.
* [BlueScale/BlueScale](https://github.com/BlueScale/BlueScale) - Sip Server written in Scala with a Web API!   A simple REST front end allows you to post parameters or return simple XML to make and control phone calls.
* [xuwei-k/nobox](https://github.com/xuwei-k/nobox) - immutable primitive array/NonEmptyArray wrapper for Scala
* [xuwei-k/ghscala](https://github.com/xuwei-k/ghscala) - purely functional scala github api client
* [wheaties/Predicates](https://github.com/wheaties/Predicates) - A small library to add some convenience methods to Scala encompassing predicate logic
* [warthog-logic/warthog](https://github.com/warthog-logic/warthog) - A Logic Framework in Scala
* [twitter/twitterActors](https://github.com/twitter/twitterActors) - Improved Scala actors library; used internally at Twitter
* [tototoshi/scala-http-client](https://github.com/tototoshi/scala-http-client) - A thin wrapper of Apache HttpClient
* [tamland/qtjambi-for-scala](https://github.com/tamland/qtjambi-for-scala) - QtJambi with some Scala sugar
* [rcano/sps](https://github.com/rcano/sps) - Scala parboiled2 syntax
* [nevillelyh/parquet-avro-extra](https://github.com/nevillelyh/parquet-avro-extra) - Scala macros for generating Parquet schema projections and filter predicates
* [nemanja-stanarevic/gmail-api-scala-client](https://github.com/nemanja-stanarevic/gmail-api-scala-client) - Asynchronous actor-based Scala library for Gmail API
* [nehanarkhede/kafka-scalathon](https://github.com/nehanarkhede/kafka-scalathon) - Kafka demos at Scalathon
* [markhibberd/yow-patterns-in-types](https://github.com/markhibberd/yow-patterns-in-types) - YOW 2013 - Introduction to Functional Programming in Scala
* [kryptt/play2-scalate-plugin](https://github.com/kryptt/play2-scalate-plugin) - Plugin that integrates Scalate with PlayFramework
* [jimmc/nioserver](https://github.com/jimmc/nioserver) - Scala multi-client stateful server using Java NIO and Scala continuations
* [heathermiller/scala-pickling](https://github.com/heathermiller/scala-pickling) - Fast, customizable, boilerplate-free pickling support for Scala. MOVED TO http://github.com/scala/pickling
* [gilt/gfc-avro](https://github.com/gilt/gfc-avro) - An Avro serialiser based on Scala pickling
* [HendraWijaya/syndor](https://github.com/HendraWijaya/syndor) - Example application using Scala, Akka, MongoDB, Rome, async-http-client, salat, and casbah to read/update feeds asynchronously
* [tnm/tarski](https://github.com/tnm/tarski) - Validations for Scala
* [t-pleasure/mighty-csv](https://github.com/t-pleasure/mighty-csv) - scala csv library.
* [sclasen/heroku.scala](https://github.com/sclasen/heroku.scala) - scala client for the heroku platform api
* [rsimon/scala-force-layout](https://github.com/rsimon/scala-force-layout) - Force-directed graph layout implementation in Scala
* [rjenkins/riak-scala-dao](https://github.com/rjenkins/riak-scala-dao) - Reusable persistence layer for use with Basho's Riak
* [nicholasren/moco-scala](https://github.com/nicholasren/moco-scala) - scala dsl for moco
* [mariofusco/scaladrools](https://github.com/mariofusco/scaladrools) - Experimenting with Drools in Scala
* [kenichiro22/yabe-play20-scala](https://github.com/kenichiro22/yabe-play20-scala) - yabe sample with play 2.0 for scala
* [jbrechtel/Android-Scala-Installer](https://github.com/jbrechtel/Android-Scala-Installer) - An Android application that installs Scala libraries to your rooted Android device as shared libraries.
* [jakedouglas/memcached.scala](https://github.com/jakedouglas/memcached.scala) - simple scala memcached client
* [gnieh/sohva](https://github.com/gnieh/sohva) - CouchDB tools for Scala
* [etorreborre/specs-before-google-code-import](https://github.com/etorreborre/specs-before-google-code-import) - specs is a BDD library for the Scala language
* [bmc/scalasti](https://github.com/bmc/scalasti) - A Scala interface to the Java StringTemplate library
* [benmur/riemann-scala-client](https://github.com/benmur/riemann-scala-client) - Scala client library for sending events to Riemann
* [alaz/tailf](https://github.com/alaz/tailf) - tail -f written in Scala
...
* [snowplow/snowplow](https://github.com/snowplow/snowplow) - Enterprise-strength web, mobile and event analytics, powered by Hadoop, Kinesis, Redshift and Elasticsearch
...
* [twitter/iago](https://github.com/twitter/iago) - A load generator, built for engineers
...
* [n8han/giter8](https://github.com/n8han/giter8) - a command line tool to apply templates defined on github
* [twitter/cassovary](https://github.com/twitter/cassovary) - Cassovary is a simple big graph processing library for the JVM
* [non/cats](https://github.com/non/cats) - Lightweight, modular, and extensible library for functional programming.
* [typesafehub/sbteclipse](https://github.com/typesafehub/sbteclipse) - Plugin for sbt to create Eclipse project definitions
* [t2v/play2-auth](https://github.com/t2v/play2-auth) - Play2.x Authentication and Authorization module
* [CSUG/HouseMD](https://github.com/CSUG/HouseMD) - HouseMD is an awesome diagnosing tool better than BTrace
...
* [salat/salat](https://github.com/salat/salat) - Salat is a simple serialization library for case classes.
* [sameeragarwal/blinkdb](https://github.com/sameeragarwal/blinkdb) - BlinkDB: Sub-Second Approximate Queries on Very Large Data.
* [play2war/play2-war-plugin](https://github.com/play2war/play2-war-plugin) - WAR Plugin for Play framework 2.x
...
* [pfn/android-sdk-plugin](https://github.com/pfn/android-sdk-plugin) - An easy-to-use sbt plugin for working with all Android projects
...
* [quantifind/KafkaOffsetMonitor](https://github.com/quantifind/KafkaOffsetMonitor) - A little app to monitor the progress of kafka consumers and their lag wrt the queue.
* [geotrellis/geotrellis](https://github.com/geotrellis/geotrellis) - GeoTrellis is a geographic data processing engine for high performance applications.
...
* [bigdatagenomics/adam](https://github.com/bigdatagenomics/adam) - ADAM is a genomics analysis platform with specialized file formats built using Apache Avro, Apache Spark and Parquet. Apache 2 licensed.
...
* [Netflix/edda](https://github.com/Netflix/edda) - Service to track changes in your cloud
...
* [macroid/macroid](https://github.com/macroid/macroid) - A modular functional UI language for Android
...
* [MrTJP/ProjectRed](https://github.com/MrTJP/ProjectRed) - Extending redstone functionality to FMP
...
* [oncue/remotely](https://github.com/oncue/remotely) - An elegant RPC system for reasonable people
...
* [p2t2/figaro](https://github.com/p2t2/figaro) - Figaro Programming Language and Core Libraries
...
* [stephenmcd/curiodb](https://github.com/stephenmcd/curiodb) - Distributed & Persistent Redis Clone built with Scala & Akka
...
* [wandoulabs/spray-socketio](https://github.com/wandoulabs/spray-socketio) - socket.io for spray
...
* [jacobus/s4](https://github.com/jacobus/s4) - Spray Slick Starter Stack
* [wandoulabs/spray-websocket](https://github.com/wandoulabs/spray-websocket) - WebSocket for spray-can
* [scalanlp/chalk](https://github.com/scalanlp/chalk) - Chalk is a natural language processing library.
* [lihaoyi/upickle-pprint](https://github.com/lihaoyi/upickle-pprint) - Combined repository for uPickle/PPrint
* [databricks/spark-csv](https://github.com/databricks/spark-csv) - CSV data source for Spark SQL and DataFrames
* [slick/slick-examples](https://github.com/slick/slick-examples) - A sample project for getting started with Slick
* [OpenBankProject/OBP-API](https://github.com/OpenBankProject/OBP-API) - A RESTful API for banks that supports: accounts, transactions, counterparties, transfers (payments), entitlements (permissions), metadata on the above (comments, tags, geo tags, urls etc.), multiple views on accounts (my data, shared data, open data), cards etc..
* [subliun/Antox](https://github.com/subliun/Antox) - Android client for Project Tox - secure p2p messaging
* [stanford-ppl/Delite](https://github.com/stanford-ppl/Delite) - The Delite Git Repo
* [cloudera/spark-timeseries](https://github.com/cloudera/spark-timeseries) - A library for financial and time series calculations on Apache Spark
* [Treode/store](https://github.com/Treode/store) - The DB that's replicated, sharded and transactional.
* [non/jawn](https://github.com/non/jawn) - Jawn is for parsing jay-sawn (JSON)
...
* [sgodbillon/reactivemongo-demo-app](https://github.com/sgodbillon/reactivemongo-demo-app) - Full web application built upon Play 2.0 and ReactiveMongo
* [sbt/sbt-buildinfo](https://github.com/sbt/sbt-buildinfo) - I know this because build.sbt knows this.
* [gideondk/sentinel](https://github.com/gideondk/sentinel) - Boilerplate for creating reactive TCP clients / servers on Akka IO (2.3)
* [deanwampler/spark-workshop](https://github.com/deanwampler/spark-workshop) - A Typesafe Activator tutorial for Apache Spark.
...
* [levkhomich/akka-tracing](https://github.com/levkhomich/akka-tracing) - A distributed tracing extension for Akka. Provides integration with Play framework and Spray.
* [banana-rdf/banana-rdf](https://github.com/banana-rdf/banana-rdf) - Banana RDF
* [mandubian/play-autosource](https://github.com/mandubian/play-autosource) - Play Autosource : 1mn REST/Crud/Async/Typesafe Datasource for Play Framework
...
* [mysema/scalagen](https://github.com/mysema/scalagen) - Java to Scala transformation
* [karthik20522/SprayLearning](https://github.com/karthik20522/SprayLearning) - Learning
* [mojodna/metricsd](https://github.com/mojodna/metricsd) - A metrics aggregator for Graphite
* [wandoulabs/chana](https://github.com/wandoulabs/chana) - Avro Data Store based on Akka
...
* [twitter/standard-project](https://github.com/twitter/standard-project) - A slightly more standard sbt project plugin library
* [dlwh/puck](https://github.com/dlwh/puck) - Puck is a lightning-fast parser for natural languages using GPUs
* [Chicken-Bones/ForgeMultipart](https://github.com/Chicken-Bones/ForgeMultipart) - An API for dynamically handling different functional parts in the one block space.
* [slamdata/slamengine](https://github.com/slamdata/slamengine) - A NoSQL analytics engine that embraces post-relational analytics and pushes computation to the data.
* [sbt/sbt-start-script](https://github.com/sbt/sbt-start-script) - SBT Plugin to create a "start" script to run the program
...
* [backchatio/hookup](https://github.com/backchatio/hookup) - A reliable netty websocket server built on top of akka
* [teamon/play-navigator](https://github.com/teamon/play-navigator) - Better router for Play Framework 2.x
* [non/kind-projector](https://github.com/non/kind-projector) - Compiler plugin for making type lambdas (type projections) easier to write
* [ktoso/akka-raft](https://github.com/ktoso/akka-raft) - An akka-cluster ready implementation of the raft consesus alg
...
* [mumoshu/play2-memcached](https://github.com/mumoshu/play2-memcached) - A memcached plugin for Play 2.x
* [eigengo/monitor](https://github.com/eigengo/monitor) - Library for monitoring the Typesafe stack-based applications.
...
* [strongtyped/active-slick](https://github.com/strongtyped/active-slick) - Slick extensions for record lifecycle management
* [non/algebra](https://github.com/non/algebra) - Experimental project to lay out basic algebra type classes
...
* [ge0rg/aprsdroid](https://github.com/ge0rg/aprsdroid) - APRSdroid - Android APRS reporting tool
* [guardian/gu-who](https://github.com/guardian/gu-who) - answering: who are all these users in my GitHub org?
* [guardian/deploy](https://github.com/guardian/deploy) - Guardian deployment libraries and RiffRaff frontend
* [milliondreams/socket.io.play](https://github.com/milliondreams/socket.io.play) - socket.io with play framework 2.0
* [angyjoe/eventual](https://github.com/angyjoe/eventual) - The Eventual PlayFramework-AngularJS-Bootstrap-MongoDB Seed Project
* [velvia/links](https://github.com/velvia/links) - Just a bunch of useful links
* [twitter/haplocheirus](https://github.com/twitter/haplocheirus) - A Redis-backed storage engine for timelines
* [scaled/scaled](https://github.com/scaled/scaled) - One man's quixotic adventure.
* [nkallen/Rowz](https://github.com/nkallen/Rowz) - A sample gizzard application
* [walmartlabs/mupd8](https://github.com/walmartlabs/mupd8) - Muppet
* [orrsella/sbt-sublime](https://github.com/orrsella/sbt-sublime) - An sbt pluign for generating Sublime Text projects with library dependencies sources
* [foursquare/slashem](https://github.com/foursquare/slashem) - A rogue-like DSL for querying SOLR
...
* [timperrett/lift-in-action](https://github.com/timperrett/lift-in-action) - Source code for the book "Lift in Action", publishing on Manning Q4 2011
* [lihaoyi/SprayWebSockets](https://github.com/lihaoyi/SprayWebSockets) - An implementation of a websocket server on top of spray.io
* [uzh/signal-collect](https://github.com/uzh/signal-collect) - A framework for scalable graph computing.
* [databricks/spark-perf](https://github.com/databricks/spark-perf) - Performance tests for Spark
...
* [djspiewak/cccp](https://github.com/djspiewak/cccp) - Common Colaborative Coding Protocol
* [m3dev/octoparts](https://github.com/m3dev/octoparts) - Octoparts, the backend services aggregator
* [geeksville/arduleader](https://github.com/geeksville/arduleader) - An android ground controller (and other things) for Mavlink/Arduplane
* [ochrons/boopickle](https://github.com/ochrons/boopickle) - Binary serialization library for efficient network communication
* [jsuereth/sbt-in-action-examples](https://github.com/jsuereth/sbt-in-action-examples) - Source code examples for the book "sbt in Action"
* [echen/scaldingale](https://github.com/echen/scaldingale) - Movie recommendations and MOAR in MapReduce and Scalding
* [amplab/training](https://github.com/amplab/training) - Training materials for Strata, AMP Camp, etc
* [mbknor/ddsl](https://github.com/mbknor/ddsl) - DDSL - Dynamic Distributed Service Locator
* [teamon/akka.js](https://github.com/teamon/akka.js) - akka actors for java script
* [sbt/sbt-atmos](https://github.com/sbt/sbt-atmos) - sbt plugin for running Typesafe Console in development
* [julienrf/play-jsmessages](https://github.com/julienrf/play-jsmessages) - Library to compute localized messages of your Play application on client side
* [stephenjudkins/pureimage](https://github.com/stephenjudkins/pureimage) - puts the "fun" in "functional raster image processing"
* [jlitola/play-sass](https://github.com/jlitola/play-sass) - Sass asset handling for Play Framework 2.0
* [DiUS/pact-jvm](https://github.com/DiUS/pact-jvm) - JVM version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
* [mbryzek/apidoc](https://github.com/mbryzek/apidoc) - Beautiful documentation for REST services. Simple native client libraries with no dependencies.
* [NET-A-PORTER/spray-actor-per-request](https://github.com/NET-A-PORTER/spray-actor-per-request) - Example spray application that uses the actor per request model
* [wolfe-pack/wolfe](https://github.com/wolfe-pack/wolfe) - Wolfe Language and Engine
* [romix/akka-kryo-serialization](https://github.com/romix/akka-kryo-serialization) - Kryo-based serialization for Akka
* [kenshoo/metrics-play](https://github.com/kenshoo/metrics-play) - Metrics module for Play2
* [jamie-allen/effective_akka](https://github.com/jamie-allen/effective_akka) - Source code from my Effective Akka work
* [debasishg/cqrs-akka](https://github.com/debasishg/cqrs-akka) - An implementation of CQRS using scalaz for functional domain models and Akka for event sourcing
* [pjay/plush](https://github.com/pjay/plush) - Push notifications for mobile apps - built on the Typesafe stack to ensure scalability
* [databricks/spark-avro](https://github.com/databricks/spark-avro) - Using Avro data format in Spark, SQL, and DataFrames
* [NICTA/rng](https://github.com/NICTA/rng) - Pure-functional random value generation
* [tc/RMongo](https://github.com/tc/RMongo) - R client to interface with MongoDB
* [cjdev/kafka-rx](https://github.com/cjdev/kafka-rx) - reactive kafka client
* [t2v/stackable-controller](https://github.com/t2v/stackable-controller) - Composable Action composition framework for Play2.x
* [ooyala/metrics_storm](https://github.com/ooyala/metrics_storm) - Easy metrics collection for Storm topologies using Coda Hale Metrics
* [Searchlight/khronus](https://github.com/Searchlight/khronus) - A reactive time series database
* [cjmx/cjmx](https://github.com/cjmx/cjmx) - Command line JMX library
* [tototoshi/play-flyway](https://github.com/tototoshi/play-flyway) - Flyway plugin for Play >= 2.1
* [loicdescotte/Play2-HTML5Tags](https://github.com/loicdescotte/Play2-HTML5Tags) - HTML5 form tags module for Play Framework
* [chrisdinn/brando](https://github.com/chrisdinn/brando) - A Redis client written with Akka's IO package
* [adamw/reactmq](https://github.com/adamw/reactmq) - Reactive Message Queue
* [twitter/sbt-package-dist](https://github.com/twitter/sbt-package-dist) - sbt 11 plugin codifying best practices for building, packaging, and publishing
* [snowplow/scalding-example-project](https://github.com/snowplow/scalding-example-project) - The Scalding WordCountJob example as a standalone SBT project with Specs2 tests, runnable on Amazon EMR
* [ScalaConsultants/reactive-rabbit](https://github.com/ScalaConsultants/reactive-rabbit) - Reactive Rabbit
* [DrewEaster/realtime-search](https://github.com/DrewEaster/realtime-search) - Demonstration using Play!, Akka, AngularJS and Elasticsearch to perform real-time log entry search
* [boldradius/akka-dddd-template](https://github.com/boldradius/akka-dddd-template) - Akka DDDD template using CQRS/ES with a Distributed Domain
* [utcompling/applied-nlp](https://github.com/utcompling/applied-nlp) - Course repository for Applied Natural Language Processing
* [joescii/lift-ng](https://github.com/joescii/lift-ng) - lift-ng is the most powerful, most secure AngularJS backend available today
* [tribbloid/ISpark](https://github.com/tribbloid/ISpark) - An Apache Spark-shell backend for IPython
* [sksamuel/akka-patterns](https://github.com/sksamuel/akka-patterns) - Implementations of common enterprise integration patterns and more using Akka
* [markchadwick/graphite-relay](https://github.com/markchadwick/graphite-relay) - A fast Graphite relay
* [dcaoyuan/aiotrade](https://github.com/dcaoyuan/aiotrade) - A Trading Platform
* [TiarkRompf/lancet](https://github.com/TiarkRompf/lancet) - surgical precision JIT compilers
* [JetBrains/intellij-sbt](https://github.com/JetBrains/intellij-sbt) - SBT support in IntelliJ IDEA
* [musk/SbtEclipsify](https://github.com/musk/SbtEclipsify) - Sbt plugin for creating eclipse project and classpath files for sbt projects
* [dcbriccetti/talking-puffin](https://github.com/dcbriccetti/talking-puffin) - dcbriccetti
...
* [n8han/pamflet](https://github.com/n8han/pamflet) - a publishing application for short texts
...
* [EventStore/EventStore.JVM](https://github.com/EventStore/EventStore.JVM) - Event Store JVM Client
* [twbs/rorschach](https://github.com/twbs/rorschach) - Bootstrap pull request sanity checker bot
* [tresata/spark-kafka](https://github.com/tresata/spark-kafka) - Low level integration of Spark and Kafka
* [pbudzik/bytecask](https://github.com/pbudzik/bytecask) - Key/value database inspired by Bitcask
* [jroper/play-iteratees-extras](https://github.com/jroper/play-iteratees-extras) - Extra iteratees for Play
* [edulify/play-hikaricp.edulify.com](https://github.com/edulify/play-hikaricp.edulify.com) - HikariCP Plugin for Playframework 2.2.x and 2.3.x
* [hoisted/hoisted](https://github.com/hoisted/hoisted) - The Hoisted Content Management System that sits on top of Lift
* [apache/samza](https://github.com/apache/samza) - Mirror of Apache Samza
* [Stratio/sparkta](https://github.com/Stratio/sparkta) - Real Time Aggregation based on Spark Streaming
* [gre/playCLI](https://github.com/gre/playCLI) - Play Framework Iteratees + UNIX pipe library
* [pocorall/hello-scaloid-sbt](https://github.com/pocorall/hello-scaloid-sbt) - A "Hello, world" of Scaloid for sbt.
* [leithaus/XTrace](https://github.com/leithaus/XTrace) - An XML-validation-based trace validator
* [storm-enroute/reactive-collections](https://github.com/storm-enroute/reactive-collections) - A concurrent reactive programming framework.
* [mhamrah/akka-docker-cluster-example](https://github.com/mhamrah/akka-docker-cluster-example) - An example akka-cluster project with docker support
...
* [bmatheny/finagle-starter-kit](https://github.com/bmatheny/finagle-starter-kit) - Getting started with Finagle
* [agourlay/omnibus](https://github.com/agourlay/omnibus) - An HTTP-friendly persistent message bus.
* [Rhinofly/play-s3](https://github.com/Rhinofly/play-s3) - [m] S3 module for Play
* [softprops/bintray-sbt](https://github.com/softprops/bintray-sbt) - fresh packages delivered from your sbt console
* [jrudolph/speed](https://github.com/jrudolph/speed) - Looping like a pro
* [gre/screenshot-webservice](https://github.com/gre/screenshot-webservice) - [WIP current state : waiting for PhantomJS bugfix] Screenshot Webservice is an open-source REST web service to perform web page screenshots.
...
* [typesafehub/reactive-stocks](https://github.com/typesafehub/reactive-stocks) - A demo application where we make decisions about stocks based on tweets.
* [reidarsollid/RustyCage](https://github.com/reidarsollid/RustyCage) - Eclipse plugin for Rust-lang.
* [lift/examples](https://github.com/lift/examples) - Lift Examples
* [ngocdaothanh/cleakka](https://github.com/ngocdaothanh/cleakka) - Cluster memory cache based on sun.misc.Cleaner and Akka
* [mesosphere/elasticsearch-mesos](https://github.com/mesosphere/elasticsearch-mesos) - Elastic Search on Mesos
* [VirtusLab/unicorn](https://github.com/VirtusLab/unicorn) - Small Slick library for type-safe id handling
* [Stratio/spark-mongodb](https://github.com/Stratio/spark-mongodb) - from
* [MfgLabs/akka-stream-extensions](https://github.com/MfgLabs/akka-stream-extensions) - Extensions for Akka Stream
* [redeyes/redeyes](https://github.com/redeyes/redeyes) - The repository for RedEyes core.
* [alexanderjarvis/DubSub](https://github.com/alexanderjarvis/DubSub) - Distributed PubSub with Akka Cluster
* [akka/akka-modules](https://github.com/akka/akka-modules) - Akka Modules Repository
* [adamw/xsbt-proguard-plugin](https://github.com/adamw/xsbt-proguard-plugin) - A plugin for XSBT to facilitate the use of ProGuard to create single jars for XSBT-managed projects
* [mrsqueeze/spark-hash](https://github.com/mrsqueeze/spark-hash) - Locality Sensitive Hashing for Apache Spark
* [bamos/girl](https://github.com/bamos/girl) - Check your GitHub READMEs for broken links.
* [tixxit/framian](https://github.com/tixxit/framian) - Framian
* [pawelkaczor/ddd-leaven-akka-v2](https://github.com/pawelkaczor/ddd-leaven-akka-v2) - Next generation of ddd-leaven-akka
...
* [gseitz/Lensed](https://github.com/gseitz/Lensed) - in your case
* [cloudera-labs/SparkOnHBase](https://github.com/cloudera-labs/SparkOnHBase) - SparkOnHBase
* [vznet/play-mongo-jackson-mapper](https://github.com/vznet/play-mongo-jackson-mapper) - MongoDB Jackson Mapper Play 2.0 Module
* [knowitall/nlptools](https://github.com/knowitall/nlptools) - A toolkit that wraps various natural language processing implementations behind a common interface.
* [theatrus/akka-quartz](https://github.com/theatrus/akka-quartz) - Because using Camel to schedule Akka actors is silly
* [laforge49/Asynchronous-Functional-Programming](https://github.com/laforge49/Asynchronous-Functional-Programming) - Fast actors using replies without future, actor-based functional programming with keyed sequences, and an versioned graphicl database.
* [holdenk/elasticsearchspark](https://github.com/holdenk/elasticsearchspark) - Elastic Search on Spark
* [ephox/vault](https://github.com/ephox/vault) - Database API
* [Primetalk/SynapseGrid](https://github.com/Primetalk/SynapseGrid) - SynapseGrid is a framework for constructing reactive real-time immutable data flow systems.
* [softprops/retry](https://github.com/softprops/retry) - because you should never give up, at least not on the first try
* [payola/Payola](https://github.com/payola/Payola) - RDF framework
* [lift/modules](https://github.com/lift/modules) - Lift Modules
* [scalding-io/ProgrammingWithScalding](https://github.com/scalding-io/ProgrammingWithScalding) - Programming MapReduce with Scalding
* [robey/smile](https://github.com/robey/smile) - actor-based memcache client library
* [Atry/fastring](https://github.com/Atry/fastring) - Extremely fast string formatting
* [scalamacros/paradise](https://github.com/scalamacros/paradise) - Let our powers combine!
...
* [jpersson/prequel](https://github.com/jpersson/prequel) - because SQL is a pretty good abstraction already
* [hseeberger/akka-sse](https://github.com/hseeberger/akka-sse) - Akka SSE adds support for Server-Sent Events to Akka HTTP
* [cage433/maker](https://github.com/cage433/maker) - How hard could it be to replace SBT?
* [Centaur/repox](https://github.com/Centaur/repox) - A fast sbt/gradle/lein/ivy/maven repository proxy
* [typelevel/shapeless-contrib](https://github.com/typelevel/shapeless-contrib) - Interoperability libraries for Shapeless
* [databricks/spark-redshift](https://github.com/databricks/spark-redshift) - Spark and Redshift integration
* [JerryLead/SparkLearning](https://github.com/JerryLead/SparkLearning) - Learning to write Spark examples
* [wsargent/play-shiro](https://github.com/wsargent/play-shiro) - An example of how to integrate Play 2.x with Shiro
* [snowplow/spark-example-project](https://github.com/snowplow/spark-example-project) - A Spark WordCountJob example as a standalone SBT project with Specs2 tests, runnable on Amazon EMR
* [rsertelon/android-keystore-recovery](https://github.com/rsertelon/android-keystore-recovery) - A tool to recover your lost Android keystore password
* [gre/zound](https://github.com/gre/zound) - Zound, a PlayFramework 2 audio streaming experiment using Iteratees
* [dpp/lift-samples](https://github.com/dpp/lift-samples) - Samples of lift-based applications
* [Imaginatio/REL](https://github.com/Imaginatio/REL) - A Regular Expression composition Library
* [mumoshu/play2-typescript](https://github.com/mumoshu/play2-typescript) - TypeScript assets handling for Play 2.0. Compiles .ts files under the /assets dir along with the project.
* [mandubian/play-json-zipper](https://github.com/mandubian/play-json-zipper) - play-json-zipper
* [godenji/play-faster](https://github.com/godenji/play-faster) - Play development without the hair pulling
* [felipehummel/TinySearchEngine](https://github.com/felipehummel/TinySearchEngine) - Vector space model implemented in a few lines
* [epfl-lara/leon](https://github.com/epfl-lara/leon) - The Leon system for verification, synthesis, and more.
* [ReactiveDesignPatterns/Chapter-2](https://github.com/ReactiveDesignPatterns/Chapter-2) - Code from the second chapter of the RDP book
...
* [sbt/sbt-groll](https://github.com/sbt/sbt-groll) - sbt plugin to roll the Git history
* [BaiGang/spark_multiboost](https://github.com/BaiGang/spark_multiboost) - An implementation of the multi-class/multi-label classifier, of which the training is carried out using AdaBoost.MH on Apache Spark.
* [typelevel/machinist](https://github.com/typelevel/machinist) - Spire's macros for zero-cost operator enrichment
...
* [mohiva/play-html-compressor](https://github.com/mohiva/play-html-compressor) - Google's HTML Compressor for Play Framework 2
* [lucperkins/spray-akka-slick-postgres](https://github.com/lucperkins/spray-akka-slick-postgres) - Spray + Akka + Slick + Postgres (simple web service)
* [cloudml/zen](https://github.com/cloudml/zen) - Zen aims to provide the largest scale and the most efficient machine learning platform on top of Spark, including but not limited to logistic regression, latent dirichilet allocation, factorization machines and DNN.
...
* [tmalaska/SparkOnHBase](https://github.com/tmalaska/SparkOnHBase) - I simple API to interact with HBase with Spark
* [timperrett/lift-shiro](https://github.com/timperrett/lift-shiro) - Lift Integration with the Shiro security framework
* [sbt/sbt-remote-control](https://github.com/sbt/sbt-remote-control) - Create and manage sbt process using unicorns and forks
* [mesosphere/sssp](https://github.com/mesosphere/sssp) - S3 Proxy Mesos Framework
* [gatling/gatling-sbt](https://github.com/gatling/gatling-sbt) - Gatling SBT plugin
* [fxthomas/sshbeam](https://github.com/fxthomas/sshbeam) - A simple app that sends files to a remote server via SFTP (SSH File Transfer Protocol)
* [dimroc/etl-language-comparison](https://github.com/dimroc/etl-language-comparison) - Count the number of times certain words were said in a particular neighborhood. Performed as a basic MapReduce job against 25M tweets. Implemented with different programming languages as a educational exercise.
* [valotrading/stirling](https://github.com/valotrading/stirling) - Stirling, an open source electronic trading library for the JVM
* [skipoleschris/xsbt-cucumber-plugin](https://github.com/skipoleschris/xsbt-cucumber-plugin) - Plugin to integrate Cucumber and Cuke4Duke into XSBT
* [kifi/multiproject](https://github.com/kifi/multiproject) - A modular Play 2.2 application using multi-projects
* [djspiewak/sparse](https://github.com/djspiewak/sparse) - Generalized, incremental parser combinators for scalaz-stream
* [chrisloy/akka-ec2](https://github.com/chrisloy/akka-ec2) - Example setup of an Akka cluster in an Amazon EC2 AutoScaling group
* [twitter/libkestrel](https://github.com/twitter/libkestrel) - libkestrel
* [softprops/sbt-growl-plugin](https://github.com/softprops/sbt-growl-plugin) - Growling sbt test results so you don't have to
* [sbt/sbt-pgp](https://github.com/sbt/sbt-pgp) - PGP plugin for SBT 0.12+
* [kifi/json-annotation](https://github.com/kifi/json-annotation) - The quickest way to add a JSON format to your Play project's case classes
* [ghostm/lift-omniauth](https://github.com/ghostm/lift-omniauth) - Omniauth for Lift
* [ebiznext/slick-macros](https://github.com/ebiznext/slick-macros) - Slick Macros
* [ReactiveCouchbase/ReactiveCouchbase-core](https://github.com/ReactiveCouchbase/ReactiveCouchbase-core) - Core library for ReactiveCouchbase
* [Cascading/scalding-tutorial](https://github.com/Cascading/scalding-tutorial) -   The Scalding tutorial as a standalone SBT project
* [stomp/stomp-spec](https://github.com/stomp/stomp-spec) - Stomp Protocol Specification
* [sgodbillon/reactivemongo-tailablecursor-demo](https://github.com/sgodbillon/reactivemongo-tailablecursor-demo) - Tailable Cursors through WebSockets with ReactiveMongo and Play 2.0
* [ponkotuy/MyFleetGirls](https://github.com/ponkotuy/MyFleetGirls) - KanColle Public View Tool
* [mandubian/play-actor-room](https://github.com/mandubian/play-actor-room) - A Room manager for Play Framework 2.2 based on WebSocket & Bots
* [huawei-noah/streamDM](https://github.com/huawei-noah/streamDM) - Stream Data Mining Library for Spark Streaming
* [eigengo/activator-akka-cassandra](https://github.com/eigengo/activator-akka-cassandra) - Activator template showing Cassandra in Akka
* [buttercoin/engine](https://github.com/buttercoin/engine) - Buttercoin Trade Engine
* [n8han/spde](https://github.com/n8han/spde) - Spde extension library for Processing
* [memsql/memsql-spark-connector](https://github.com/memsql/memsql-spark-connector) - A connector for MemSQL and Spark
* [markschaake/sprest](https://github.com/markschaake/sprest) - Sprest is a collection of libaries to make building REST services simpler using Spray.
* [jorgeortiz85/linter](https://github.com/jorgeortiz85/linter) - A linting compiler plugin
* [guillaumebort/anormtyped-demo](https://github.com/guillaumebort/anormtyped-demo) - Proof Of Concept: A fully type safe version of Anorm
* [d40cht/sbt-cpp](https://github.com/d40cht/sbt-cpp) - Sbt plugin to allow native compilation of C and C++
* [HappyMelly/teller](https://github.com/HappyMelly/teller) - Happy Melly Teller system
* [slick/play-slick-codegen](https://github.com/slick/play-slick-codegen) - Using the Slick code generator to generate Slick and Play code
* [shivawu/sbt-maven-plugin](https://github.com/shivawu/sbt-maven-plugin) - A sbt plugin which reads project definitions from pom.xml
* [shikhar/eskka](https://github.com/shikhar/eskka) - elasticsearch discovery plugin using akka cluster
* [scalapenos/stamina](https://github.com/scalapenos/stamina) - An alternative approach to serialization in akka-persistence
* [leithaus/SpecialK](https://github.com/leithaus/SpecialK) - DataLog meets NoSql
* [foursquare/foursquare-fhttp](https://github.com/foursquare/foursquare-fhttp) - A scalaj-http style library for finagle http clients
* [alexarchambault/argonaut-shapeless](https://github.com/alexarchambault/argonaut-shapeless) - Automatic argonaut codec derivation with shapeless
* [typesafehub/dbuild](https://github.com/typesafehub/dbuild) - Multi-project build tool, based on sbt.
* [robey/naggati](https://github.com/robey/naggati) - protocol codec builder for mina
* [playframework/prune](https://github.com/playframework/prune) - Performance testing tool for Play Framework
* [netvl/picopickle](https://github.com/netvl/picopickle) -  A simple yet extensible shapeless-based serialization library
* [kryptt/play2-native-packager-plugin](https://github.com/kryptt/play2-native-packager-plugin) - Play Framework Plugin for producing native system distribution packages
* [ddispaltro/sbt-reactjs](https://github.com/ddispaltro/sbt-reactjs) - React SBT Plugin using npm
* [dbpedia/lookup](https://github.com/dbpedia/lookup) - Outputs a list of ranked DBpedia resources for a search string.
* [ReactiveMongo/ReactiveMongo-Extensions](https://github.com/ReactiveMongo/ReactiveMongo-Extensions) - Extensions for ReactiveMongo
* [vznet/play-statsd](https://github.com/vznet/play-statsd) - Play Framework 2.0 statsd plugin
* [heathermiller/menthor](https://github.com/heathermiller/menthor) - Parallelizing Machine Learning-- Functionally.
* [fwbrasil/zoot](https://github.com/fwbrasil/zoot) - Thin reactive framework to provide and consume REST services
* [skrusche63/spark-fm](https://github.com/skrusche63/spark-fm) - Reactive Factorization Engine
* [rguderlei/spray-example](https://github.com/rguderlei/spray-example) - simple demo for spray/akka
* [Sotera/correlation-approximation](https://github.com/Sotera/correlation-approximation) - Spark implementation of the Google Correlate algorithm to quickly find highly correlated vectors in huge datasets
* [sstone/akka-amqp-proxies](https://github.com/sstone/akka-amqp-proxies) - Akka AMQP proxies
* [radlab/SCADS](https://github.com/radlab/SCADS) - Scalable Consistency Adjustable Data Storage
* [mpdehaan/lookatgit](https://github.com/mpdehaan/lookatgit) - Git version control statistics analyzer
* [ironfish/akka-persistence-mongo](https://github.com/ironfish/akka-persistence-mongo) - An Akka Persistence Plugin for Mongo
* [hammerlab/guacamole](https://github.com/hammerlab/guacamole) - Simple Spark-based variant calling
* [djspiewak/derivative-combinators](https://github.com/djspiewak/derivative-combinators) - An implementation of derivative parsing in the parser combinator framework
* [sbt/sbt-man](https://github.com/sbt/sbt-man) - Looks up scaladoc.
...
* [orrsella/sbt-stats](https://github.com/orrsella/sbt-stats) - An sbt plugin for source code statistics
...
* [ilya-klyuchnikov/ttlite](https://github.com/ilya-klyuchnikov/ttlite) - A SuperCompiler for Martin-Löf's Type Theory
* [ics-software-engineering/play-example-quality-assurance](https://github.com/ics-software-engineering/play-example-quality-assurance) - Automated quality assurance tool integration (checkstyle, pmd, jacoco, findbugs, javadoc/scaladoc) for the Play Framework
* [vert-x/mod-mysql-postgresql](https://github.com/vert-x/mod-mysql-postgresql) - Fully asynchronous MySQL / Postgresql Vert.x module
* [nuttycom/sbt-proguard-plugin](https://github.com/nuttycom/sbt-proguard-plugin) - A plugin for SBT to facilitate the use of ProGuard to create single jars for SBT-managed projects.
* [mailgun/kafka-http](https://github.com/mailgun/kafka-http) - Kafka http endpoint
* [jbrechtel/robospecs](https://github.com/jbrechtel/robospecs) - Robolectric support for Specs2
...
* [btd/luna](https://github.com/btd/luna) - Git Review Tool. Pages
* [tysonjh/fixme](https://github.com/tysonjh/fixme) - Date based compiler warnings & errors for FIXMEs
